...
- [ ] Finish rich transcripts and full session interaction controls.
      ...
      response alternatives are implemented; remaining work includes the
      separate durable session-tree lineage presentation, which is blocked on a normalized
