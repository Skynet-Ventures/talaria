...
CLUSTER_DEFINITIONS: dict[str, dict[str, str]] = {
    ...
    "R02-gateway-heartbeat": {
        ...
        "evidence": "Talaria codex/gateway-heartbeat@73ab2bc9884f7223964d43c7db68d1260f7356fa adds bounded silent-socket detection, immediate foreground validation, superseded-transport retirement, and exact-current inbound recovery.",
...
def _validate_talaria_references(metadata: dict[str, Any]) -> None:
    ...
    expected = {
        ...
        "gateway-heartbeat": ("codex/gateway-heartbeat", "73ab2bc9884f7223964d43c7db68d1260f7356fa", "1fa85648e98a9bf66bea5a5a97e43999d8fae980"),
